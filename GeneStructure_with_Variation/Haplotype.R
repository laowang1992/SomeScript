...
# 
vcf_file <- "./input/myb28.C2.vcf.gz"
gtf_file <- "./input/BnaC02_MYB28.gtf"
pheno_file <- "./input/WH_GLU_blup.txt"
...
Hap_out
write_tsv(x = Hap_out, file = "./output/haplotype_with_geno.txt")
...
ggsave(P_geno, filename = "./output/Genotype.pdf", width = 5, height = 4, units = "in")
ggsave(P_geno, filename = "./output/Genotype.png", width = 5, height = 4, units = "in", dpi = 500)
...
ggsave(P_pheno, filename = "./output/Phenotype.pdf", width = 3, height = 4, units = "in")
ggsave(P_pheno, filename = "./output/Phenotype.png", width = 3, height = 4, units = "in", dpi = 500)

p <- plot_grid(P_geno, P_pheno, rel_widths = c(2.5, 1))
ggsave(p, filename = "./output/GenotypeWithPhenotype.pdf", width = 8, height = 4.5, units = "in")
ggsave(p, filename = "./output/GenotypeWithPhenotype.png", width = 8, height = 4.5, units = "in", dpi = 500)
...
pdf(file = "./output/GeneStructWithVari.pdf", width = 6, height = 5)
P_gene_vari
dev.off()
png(filename = "./output/GeneStructWithVari.png", width = 6, height = 5, units = "in", res = 500)
P_gene_vari
dev.off()
